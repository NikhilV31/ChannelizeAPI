...
public class Channelize {
    ...
    public void registerFcmToken(String fcmToken) {
        if (fcmToken != null  && getCurrentUserId() != null && !getCurrentUserId().isEmpty()
                && (ChannelizePreferences.getCurrentUserFcmToken(applicationContext) == null
                || !fcmToken.equals(ChannelizePreferences.getCurrentUserFcmToken(applicationContext)))) {
            ChannelizePreferences.setCurrentUserFcmToken(applicationContext, fcmToken);
            ChannelizeOkHttpUtil apiClient = ChannelizeOkHttpUtil.getInstance(applicationContext);
            Map<String, Object> postParam = new HashMap<>();
